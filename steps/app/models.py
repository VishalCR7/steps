...
class UserProfile(models.Model):
    ...
    gender = models.CharField(null=True, blank=True, max_length=1, choices=(
        ('F', 'Female'), ('M', 'Male')), verbose_name="gender")
    aadhar_no = models.BigIntegerField(blank=True, null=True)
    nationality = models.CharField(
        max_length=100, blank=True, null=True, default='Indian')
...
class Contact(models.Model):
    ...
    contact_type = models.CharField(
        max_length=10, choices=TYPES, verbose_name="Contact Type")
...
class Social(models.Model):
    ...
    visibility = models.CharField(
        max_length=10, choices=VIS_TYPES, verbose_name="Social Visibility")
...
class Organisation(models.Model):
    ...
    org_type = models.CharField(
        max_length=10, choices=TYPES, verbose_name="Organisation Type")
...
class Experience(models.Model):
    ...
    org = models.ForeignKey(
        Organisation, on_delete=models.CASCADE, related_name='experiences')
...
class Startup(models.Model):
    user = models.OneToOneField(
        User, related_name='startup', on_delete=models.CASCADE)
    ...
    request_user = models.ForeignKey(
        User, related_name='startup_request', blank=True, null=True, on_delete=models.SET_NULL)
    ...
    members = models.ManyToManyField(
        User, related_name='startup_members', through='StartupMember', blank=True)
...
class StartupsImage(models.Model):
    title = models.CharField(max_length=50)
    file_added = models.ImageField(
        blank=False, upload_to='media/startups/imgs')
    startup = models.ForeignKey(Startup, on_delete=models.CASCADE)
...
class StartupMember(models.Model):
    ...
    access_level = models.CharField(
        max_length=10, default='M', choices=ACCESS_TYPES)
...
class StartupAchievement(models.Model):
    startup = models.ForeignKey(
        Startup, related_name='achievements', on_delete=models.CASCADE)
...
class StartupContact(models.Model):
    ...
    contact_type = models.CharField(
        max_length=10, choices=TYPES, verbose_name="Contact Type")
    startup = models.ForeignKey(
        Startup, related_name='contacts', on_delete=models.CASCADE)
    value = models.TextField()
    visibility = models.CharField(
        max_length=10, default='All', choices=VIS_TYPES, verbose_name="Contact Visibility")
...
class StartupSocial(models.Model):
    ...
    social_type = models.CharField(
        max_length=10, choices=TYPES, verbose_name="Contact Type")
    startup = models.ForeignKey(
        Startup, related_name='socials', on_delete=models.CASCADE)
    value = models.URLField()
    visibility = models.CharField(
        max_length=10, default='All', choices=VIS_TYPES, verbose_name="Social Visibility")
...
class Incubator(models.Model):
    user = models.OneToOneField(
        User, related_name='incubator', on_delete=models.CASCADE)
    name = models.CharField(max_length=200)
    website = models.URLField(blank=True, null=True)
    short_description = models.CharField(max_length=300)
    description = models.TextField(blank=True, null=True)
    request_designation = models.CharField(max_length=200)
    request_user = models.ForeignKey(
        User, related_name='incubator_request', blank=True, null=True, on_delete=models.SET_NULL)
    ...
    status = models.CharField(max_length=10, choices=STATUS_TYPES, default='S')
    members = models.ManyToManyField(
        User, related_name='incubator_members', through='IncubatorMember', blank=True)
    followers = models.ManyToManyField(
        User, related_name='incubator_follows', blank=True)
    ratings = models.ManyToManyField(
        User, related_name='rated_incubators', through='IncubatorRating', blank=True)
    incubated_startup = models.ManyToManyField(
        Startup, related_name='incubators', through='IncubatorStartup', blank=True)
...
class IncubatorContact(models.Model):
    ...
    incubator = models.ForeignKey(
        Incubator, related_name='contacts', on_delete=models.CASCADE)
    value = models.TextField()
    visibility = models.CharField(
        max_length=10, default='All', choices=VIS_TYPES, verbose_name="Contact Visibility")
...
class IncubatorSocial(models.Model):
    ...
    social_type = models.CharField(
        max_length=10, choices=TYPES, verbose_name="Contact Type")
    incubator = models.ForeignKey(
        Incubator, related_name='socials', on_delete=models.CASCADE)
    value = models.URLField()
    visibility = models.CharField(
        max_length=10, default='All', choices=VIS_TYPES, verbose_name="Social Visibility")
...
class IncubatorAchievement(models.Model):
    incubator = models.ForeignKey(
        Incubator, related_name='achievements', on_delete=models.CASCADE)
    value = models.TextField(blank=True)
    title = models.CharField(max_length=255)
...
class IncubatorFile(models.Model):
    title = models.CharField(max_length=50)
    file_added = models.FileField(
        blank=False, upload_to='media/incubators/docs')
    incubator = models.ForeignKey(Incubator, on_delete=models.CASCADE)
...
class IncubatorImage(models.Model):
    title = models.CharField(max_length=50)
    file_added = models.ImageField(
        blank=False, upload_to='media/incubators/imgs')
    incubator = models.ForeignKey(Incubator, on_delete=models.CASCADE)
...
class IncubatorPost(models.Model):
    ...
    incubator = models.ForeignKey(
        Incubator, related_name='posts', on_delete=models.CASCADE)
    value = models.TextField(blank=True)
    title = models.CharField(max_length=255)
    ...
    post_type = models.CharField(
        max_length=10, choices=POST_TYPES, verbose_name="Contact Visibility")
